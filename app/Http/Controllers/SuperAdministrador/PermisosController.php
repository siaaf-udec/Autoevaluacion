...
class PermisosController extends Controller
{
    ...
    public function data(Request $request)
    {
        ...
        if ($request->ajax() && $request->isMethod('GET')) {
            $permisos = Permission::all()->where('name', '!=', 'SUPERADMINISTRADOR')->where('name', '!=', 'ACCEDER_LINEAMIENTOS')->where('name', '!=', 'VER_LINEAMIENTOS')->where('name', '!=', 'CREAR_LINEAMIENTOS')->where('name', '!=', 'MODIFICAR_LINEAMIENTOS')->where('name', '!=', 'ELIMINAR_LINEAMIENTOS')
