<!-- Default stylesheets-->
<link href="{{ asset('titan/assets/lib/bootstrap/dist/css/bootstrap.min.css') }}" rel="stylesheet">
...
<link href="{{ asset('titan/assets/lib/owl.carousel/dist/assets/owl.theme.default.min.css') }} " rel="stylesheet">
