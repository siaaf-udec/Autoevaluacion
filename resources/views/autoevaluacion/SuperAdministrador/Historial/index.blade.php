...
@section('content')
    @component('admin.components.panel')
        @slot('title', 'Historial')
        <div class="row">
            <div class="col-xs-6">
                <form action="#" method="post" id="form_selecionar_proceso">
                    <div class="col-md-8 col-sm-8 col-xs-12">
                        {!! Form::select('PK_PCS_Id', isset($procesos_historial)?$procesos_historial:[], old('PK_PCS_Id'), ['class' => 'select2 form-control',
                        'placeholder' => 'Seleccione un proceso', 'required' => '', 'id' => 'proceso_historial']) !!}
                    </div>
                </form>
            </div>
...
@can('SUPERADMINISTRADOR')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#proceso_historial").change(function () {
