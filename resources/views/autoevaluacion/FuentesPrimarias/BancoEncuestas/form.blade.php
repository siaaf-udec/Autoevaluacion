<div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! Form::text('BEC_Nombre', old('BEC_Nombre'),[ 'class' => 'form-control col-md-6 col-sm-6 col-xs-12', 
        'required' => 'required', 
...
<div class="item form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
        {!! Form::textarea('BEC_Descripcion', old('BEC_Descripcion'),[ 'class' => 'form-control col-md-6 col-sm-6 col-xs-12', 
        'required' => 'required', 
